...
export const CHAR_MAP: { [key: string]: string } = {
    ...
    // Cyrillic uppercase
    'А': '72', 'Б': '73', 'В': '74', 'Г': '75', 'Д': '76', 'Е': '77', 'Ё': '77', 'Ж': '78', 'З': '79', 'И': '80', 'Й': '81', 'К': '82', 'Л': '83', 'М': '84', 'Н': '85', 'О': '86', 'П': '87', 'Р': '88', 'С': '89', 'Т': '90', 'У': '91', 'Ф': '92', 'Х': '93', 'Ц': '94', 'Ч': '95', 'Ш': '96', 'Щ': '97', 'Ъ': '98', 'Ы': '99', 'Ь': '08', 'Э': '09', 'Ю': '27', 'Я': '30',
    // Cyrillic lowercase
    'а': '32', 'б': '33', 'в': '34', 'г': '36', 'д': '37', 'е': '38', 'ё': '38', 'ж': '39', 'з': '40', 'и': '42', 'й': '43', 'к': '45', 'л': '52', 'м': '53', 'н': '55', 'о': '56', 'п': '58', 'р': '59', 'с': '61', 'т': '62', 'у': '63', 'ф': '65', 'х': '66', 'ц': '67', 'ч': '73', 'ш': '75', 'щ': '76', 'ъ': '78', 'ы': '79', 'ь': '82', 'э': '83', 'ю': '84', 'я': '85',
};
...
export function textToDtmfSequence(text: string, addLog: (message: string, type?: 'info' | 'error' | 'warning') => void): string {
    ...
    // Replace 'ё' with 'е' for both cases before processing
